<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMst1.master" AutoEventWireup="true" CodeFile="s_lawyer.aspx.cs" Inherits="admin_s_lawyer" %>
    ...
    <form runat="server">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <!-- Breadcrumbs-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Lawyer Information
                    </li>
                </ol>
